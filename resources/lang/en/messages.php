...
return [
    ...
    'pengguna'          =>  'User',
    'kategori'          =>  'Category',
    'kategori_desc'     =>  'Various online booking categories from us, booking a place for training or something else. Everything is at Olshop Ibansyah',
    ...
    'joins'             =>  "Join",
    'adalahs'           =>  'Olshop Ibansyah is a subsidiary of PT. Japa Maju Bersama is engaged in the digital era in the field of sports online booking and others.',
    ...
    'terms_desc'        =>  '
        These Terms and Conditions constitute an agreement between Partner/partner (“You”) and Olshop Ibansyah (“We”),
        ...
        These Terms and Conditions govern you when accessing and using the application, website (https://Olshop Ibansyah. and other websites that we manage),
        features, technology, content and services that we provide (hereinafter, collectively referred to as the "Olshop Ibansyah Platform").
        ',

    'terms_descc'       =>  '
        By using the Olshop Ibansyah Platform, you agree that you have read, understood,
             ...
             then you are not allowed to use the Olshop Ibansyah Platform. These Terms of Use can be changed, modified,
             ...
             regularly on the Olshop Ibansyah Platform.
        ',

    'terms_desc1'       =>  'OPENING YOUR ACCOUNT',

    'terms_desc2'       =>  '
        Before using the Olshop Ibansyah Platform, you agree to these Terms and Conditions and register yourself by providing
        the information we need. When registering, we will ask you to provide your full name, e-mail address
        and personal mobile phone number. We can also stop using the Olshop Ibansyah Platform if in the future
        the data that you provide to us is proven to be incorrect.
        ',

    'terms_descc2'      =>
    '
        Our system will create an account on the Olshop Ibansyah Platform ("Account") for you to use
    ...
    'terms_desc6'       =>  '
        We do not guarantee that the Olshop Ibansyah Platform, or the content on it, will always be available or uninterrupted.
        Permission to access the Olshop Ibansyah Platform is temporary. We may suspend, withdraw, terminate or replace any part of
        the Olshop Ibansyah Platform without prior notification. We are not responsible for any reason that makes
        the Olshop Ibansyah Platform unavailable at certain times or periods.
        ',
    'terms_desc7'       =>  "
        You are responsible for making all necessary arrangements to gain access to the Olshop Ibansyah Platform.
        ",
    'terms_desc8'       =>  'PROHIBITED USE',
    'terms_desc9'       =>  "
        You are only allowed to use the Olshop Ibansyah Platform for lawful purposes. You may not use the Olshop Ibansyah Platform:
        ",
    'terms_desc10'      =>  '
    ...
    'terms_desc17'      =>  '
        Not to produce, duplicate, copy, or resell any part of the Olshop Ibansyah Platform that is contrary to
        the provisions of the Olshop Ibansyah Platform Terms and Conditions
        ',
    'terms_desc18'      =>  '
        Not to provide personal information regarding the cellphone number of the partner/partner of Olshop Ibansyah or other
    ...
    'terms_desc19'      =>  '
        To only communicate with users/customers who want to ask questions to
         partners/partners of Olshop Ibansyah vendors through chatbots that have been provided on the application platform and the Olshop Ibansyah website.
        ',
    'terms_desc20'      =>  '
        To be willing to make transactions or services to users/customers only through the application platform or the Olshop Ibansyah website.
        ',
    'terms_desc21'      =>  'Not to access without permission, disrupt, destroy, or mess up:',
    'terms_desc22'      =>  'Any part of the Olshop Ibansyah Platform;',
    'terms_desc23'      =>  "The equipment or network where the Olshop Ibansyah Platform is stored;",
    'terms_desc24'      =>  "Any software used in the provision of the Olshop Ibansyah Platform; or",
    'terms_desc25'      =>  '
    ...
    'terms_desc26'      =>  '
        ...
        ',
    'terms_desc27'      =>  '
        The Olshop Ibansyah Platform, including but not limited to, names, logos, program codes, designs, trademarks,
        ...
        ',
    'terms_desc28'      =>  '
        You may download extracts from certain pages of the Olshop Ibansyah Platform for personal use during your subscription period.
        ',
    'terms_desc29'      =>  '
    ...
    'terms_desc32'      =>  '
        License, derivative license, sell, resell, transfer, assign, distribute,
         ...
         others associated with the Olshop Ibansyah Platform in any way;
        ',
    'terms_desc33'      =>  "
        ...
        ",
    'terms_desc34'      =>  '
        Reverse engineer or access the Olshop Ibansyah Platform in order to (a) build competitive products or services,
         (b) build products based on ideas, features, functions, or graphics that are similar to the Olshop Ibansyah Platform, or
         (c) copy ideas, features, functions or graphics on the Olshop Ibansyah Platform;
        ',
    'terms_desc35'      =>  '
        Launching automated programs or scripts including, but not limited to, web spiders,
         ...
         disrupting the operation and/or performance of the Olshop Ibansyah Platform;
        ',
    'terms_desc36'      =>  '
        Using robots, spiders, site search or retrieval applications,
         ...
         avoid the navigation structure or display of the Olshop Ibansyah Platform and its content;
        ',
    'terms_desc37'      =>  '
    ...
    'terms_desc38'      =>  '
        Remove any copyright, trademark, or rights notices
         other ownership contained in the Olshop Ibansyah Platform.
         ...
         You may not use any part of the content on the Olshop Ibansyah Platform for commercial purposes
    ...
    'terms_desc39'      =>  '
        You (i) may not send unsolicited and infringing spam or duplicative messages
         ...
         The Olshop Ibansyah platform and the data contained therein; (v) shall not attempt to gain unauthorized access to
    ...
    'terms_desc40'      =>  '
        ...
        ',
    'terms_desc41'      =>  '
        If you print, copy or download any part of the infringing Olshop Ibansyah Platform
         These Terms of Use, your right to use the Olshop Ibansyah Platform will immediately terminate and you must,
    ...
    'terms_desc42'      =>  '
        We reserve the right to investigate or prosecute any form of violation
         ...
         oversee Your access to the Olshop Ibansyah Platform, but We reserve the right to do so with
         the purpose of operating the Olshop Ibansyah Platform, ensuring your compliance with these Terms and Conditions,
    ...
    'terms_desc47'      =>  "
        You are solely responsible for the decisions you make to use or
         access the Olshop Ibansyah Platform. You must behave respectfully and you shouldn't
         engaging in unlawful, threatening or harassing behavior or actions when
         using the Olshop Ibansyah Platform
        ",
    'terms_desc48'      =>  '
        You are fully responsible for any losses and/or claims arising from the use
         The Olshop Ibansyah platform through your account, either by you or other parties using your account,
    ...
    'terms_desc49'      =>  '
        We do not guarantee that the Peesanin.com Platform will be safe or free from bugs or viruses.
         ...
         as well as the platform you use to access the Olshop Ibansyah Platform.
    ...
    'terms_desc50'      =>  '
        ...
        ',
    'terms_desc51'      =>  '
        The Olshop Ibansyah platform that we provide is as is and we are
    ...
    'terms_desc52'      =>  '
        ...
        ',
    'terms_desc53'      =>  '
        Use of, or inability to use, the Olshop Ibansyah Platform; or
        ',
    'terms_desc54'      =>  '
        Use or belief in any content displayed on the Olshop Ibansyah Platform.
        ',
    'terms_desc55'      =>  '
        You agree not to use the Olshop Ibansyah Platform for any commercial or business purposes.
        ',
    'terms_desc56'      =>  '
        We are not responsible for any loss or damage caused by viruses,
         ...
         anything from the Olshop Ibansyah Platform or other websites linked to it by you.
        ',
    'terms_desc57'      =>  '
        We are not obligated to monitor your access or use of the Olshop Ibansyah Platform.
         However, we will continue to supervise to ensure the smooth use of the Olshop Ibansyah Platform
        ...
        ',
    'terms_desc58'      =>  '
        We are not responsible for the content of websites linked to the Olshop Ibansyah Platform.
    ...
    'terms_desc59'      =>  '
        ...
        ',
    'terms_desc60'      =>  '
        The Olshop Ibansyah platform may be interrupted by unauthorized events or
    ...
    'terms_desc66'      =>  '
        We may update the Platform from time to time and change the content at any time.
         ...
         We do not guarantee that the Olshop Ibansyah Platform, or the content contained therein, can
    ...
    'mitra_sect_1'          =>  'In collaboration with Olshop Ibansyah and spread throughout Indonesia.',
    ...
    'tutor_section_title1'  =>  "Let's reach more customers by registering as a Olshop Ibansyah Business Partner",
    'tutor_section_title2'  =>  'Your Outlet / Business can be seen by ',
    'tutor_section_title3'  =>  'users of the Olshop Ibansyah application throughout Indonesia.',
    ...
    'belum_ada_akun'    =>  "Don't have an Olshop Ibansyah account yet? Register",
    'disinih'           =>  'here',
    ...
    'email_contoh'      =>  '
            Enter an active email address, the email will be used for
            receive OTP Verification Code from Olshop Ibansyah and Notification from
            Olshop Ibansyah
        ',
    'nohp_contoh'       =>  '
            Enter an active mobile number, the mobile number will be used when you forget the pin on your account
    ...
    'faq_q1'                =>  'How to register for a New Olshop Ibansyah Partner?',
    'faq_q2'                =>  'How do I register for a new branch at Olshop Ibansyah?',
    ...
    'faq_a1'                =>  "You can register your outlet / business at Olshop Ibansyah. It's easy! Follow these steps:",
    'faq_a1_1'              =>  'Prepare a copy / scan of KTP / other identity (SIM / PASSPORT)',
    'faq_a1_2'              =>  'Prepare Photocopy / Scan of Business TIN (optional)',
    'faq_a1_3'              =>  'Prepare an active email address that has never been registered with Olshop Ibansyah',
    'faq_a1_4'              =>  'A cellphone number that has never been registered on Olshop Ibansyah',
    ...
    'faq_a2_3'              =>  'Send the completed form via email hipesanin@Olshop Ibansyah, and attach the following supporting documents:',
    ...
    'faq_a3_1'              =>  'To change the Outlet Address or position on the GPS, please send an email to hipesanin@Olshop Ibansyah, with the following conditions.',
    'faq_a3_2'              =>  'Email subject:',
    'faq_a3_3'              =>  'Update Merchant - (Name of Outlet) - (Name of City):',
    'faq_a3_4'              =>  'Outlet Name (as stated on the Olshop Ibansyah application):',
    ...
    'faq_a4_1'              =>  'If you have already made an order, you can cancel it in the order menu on the Olshop Ibansyah application',
    ...
    'breadcrumb_1'      =>  "Get the opportunity to expand your market segmentation by joining as a Olshop Ibansyah partner",
    'breadcrumb_2'      =>  "Confused about becoming a partner of Olshop Ibansyah? Let's follow how to become a partner of Olshop Ibansyah",
    'breadcrumb_3'      =>  'Enjoy the various features of Olshop Ibansyah in your hands',
    'breadcrumb_4'      =>  'This is your chance to make a meaningful change',
    'breadcrumb_5'      =>  'A journey',
    'breadcrumb_6'      =>  'Closer acquaintance with the history of Olshop Ibansyah and the people behind it',
    ...
    'milestone_1'       =>  '
        The creation of the name Olshop Ibansyah from 4 founders.
        And the name is identical to 1 Mission from Olshop Ibansyah, namely the First All In One Booking in Indonesia
        ',

    'milestone_2'       =>  '
        The creation of the Olshop Ibansyah logo, where the logo is identical in color to the vision, mission and 4 founders.
        The color gradation on Olshop Ibansyah is a color that symbolizes brightness in the scope and ideas of the team and founders of
        Olshop Ibansyah
        ',

    'milestone_3'       =>  '
        The Olshop Ibansyah application was created. To make it easier for users to carry out activities or hold events online.
        No need to bother coming or contacting the relevant parties. With the Olshop Ibansyah application, you can place orders, book weeding events and more
        easily and quickly. With several payment methods that have worked with Olshop Ibansyah
        ',

    'milestone_4'       =>  '
        The journey of Olshop Ibansyah has started, and there are already several partners who have joined Olshop Ibansyah to make it easier for users to book online.
        ',
    ...
    'akun_belum_diaktifkan' => 'Please wait for confirmation from Olshop Ibansyah to activate your partner account',
    ...
    'kenalan_lebih_dekat' => 'Get Closer to the People of Olshop Ibansyah',
    'pengguna_terdaftar' => 'Registered User',
    'kategori_terdaftar' => 'Preferred Category',
    'produk_terdaftar' => 'Booking Options',
    'partner_terdaftar' => 'Partner of Olshop Ibansyah',
    ...
    'forgot_success' => 'Your password reset token was successfully sent to your email, please check your email in inbox/spam',

    'reset_success' => 'Password changed successfully',
    'kata_sandi_tidak_cocok' => 'Password did not matched',
    'keranjang' => 'Cart',
    'akun' => 'Account',
    'lanjut_pembayaran' => 'Continue Payment',
    'ukuran' => 'Size',
    'login_dahulu' => 'Please Login first',
    'lihat_detail' => 'View Details',
    'product_not_found' => 'Product not found',
    'mulai_belanja' => 'Start Shopping',
    'data_tersedia' => 'Looks like your data is already available',
    'subscribe_success' => 'Thank you for subscribing to our newsletter, we will keep you updated via email',
    'toko' => 'Store',
    'kembali_ke_beranda' => 'Return to Home',
    'produk_belum_tersedia' => 'Product Not Available',
    'descrip' => 'Description',
    'tambah_keranjang' => 'Add Cart',
    'atau' => 'Or',
    'masuk_dengan_google' => 'Sign in with Google',
    'regist_manual' => 'An error occurred, please register via email',
    'verifikasi' => 'Verify your account first, check your email now',
    'pengguna_tidak_ditemukan' => 'User not found',
    'pengguna_non_aktif' => 'The user has been deactivated by the system',
